...
const ClimateChange2 = () => {
  ...
  return (
    <main className="article campaign">
      <header className="entry-header high-impact-viewport">
      ...
      <div className="feature-chart">
        ...
        <div className="embed-chart">
          <p>
            Embed this chart in your web page:{" "}
            <span className="cta with-icon on-dark toggle-embed">
              Embed chart
            </span>
          </p>
          ...
          <section className="x decade-1">
            <div className="c l6">
              <div className="text">
                ...
                <p>
                  The IPCC predicts that unless there is significant change
                  before 2030, then the catastrophic effects of the warming
                  planet become unavoidable, and it is too late to save
                  ourselves. We are already feeling some effects of a changing
                  climate, but if the world continues with its half-hearted
                  commitments to emission reduction, the events in this list
          ...
          <section className="x decade-2">
            ...
            <div className="c l6">
              <div className="text">
                ...
                <p>
                  In USA, 40% of the population lives in high population-density
                  coastal areas, and Globally, 8 of the world’s 10 largest
                  cities are near a coast. USA will need to spend around $10
                  billion to protect each coastal city, replenishing defences
                  every 20 years, or facing the consequences of $billions in
                  flood damages. It is the same around the world, and it is
                  unclear where the money will come from.{" "}
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="c l6">
              <div className="text">
                ...
                <p>
                  ...
                  farming and crops. Large parts of Africa will simply become
                  desert, where growing food becomes impossible. In parts of
                  Asia, heavier rainfall and constant floods will destroy crops.
                  The area where food can be grown will significantly decrease,
                  making it a true challenge to feed the world.
                </p>
              </div>
            </div>
            <picture className="c l6">
          ...
          <section className="x decade-4">
            ...
            <div className="c l6">
              <div className="text">
                ...
                <p>
                  The natural phenomenon, a bucket list location for so many
                  people, will almost completely die due to rising temperatures,
                  bleaching and ocean acidification. Reefs will die across the
                  globe, and it’s not just a lost tourist attraction, its death
                  means further devastation of marine eco-systems, causing huge
                  numbers of species to go extinct. By this point, also due to
                  overfishing, it’s safe to say you won’t be able to pick up
                  seafood for dinner in your local supermarket.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="c l6">
              <div className="text">
                ...
                <p>
                  ...
                  can absolutely destroy large eco-systems, starting with the
                  oceans before eventually impacting land animals. Polar bears,
