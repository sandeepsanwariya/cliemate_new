...
function All_country() {
  ...
  return (
    <>
      <h1>
        <span id="con_name"></span> Sea Level Rise Map
      </h1>
      <div hidden>
      ...
      <p>
        See how the sea level is predicted to rise over the next 100 years in{" "}
        <span id="con_name2"></span> as a result of climate change.
      </p>
      <div>
